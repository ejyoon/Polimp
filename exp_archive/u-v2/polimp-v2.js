...
var sents = {
    scales: {
		training1: {
		    ...
		    sent_question:  "SP hates reading books?"
		},	
	   training2: {
        ...
        someHate_butNotAll: {
            ...
            sent_question: "some people did not hate your BB?"
        },
        
        someLove_butNotAll: {
            sent_QUD: "How did people like my BB?",
            sent_utterance: "Some people loved your BB.", 
            sent_question: "some people did not love your BB?"
        },
    ...
    domains: {
	training1: {
	    sent_context: "Imagine that you and SP were talking about your favorite pastimes.",
        SP: speakers1[0],
	    LS: speakers1[1],
...
//	   sent_context = sents["domains"][domain]["sent_context"];
	   ...
	   sent_materials = doSentSubs(sents, scale, domain);	
	    ...
	    $("#speaker").html("<center><i>" + sent_materials[3] + " said to you:</i></center>")
	    $("#sent_utterance").html("<center><b>\"" +
				      sent_materials[0] + "\"</b></center><br><br>");
	    $("#sent_question").html("<center>Based on what " + sent_materials[3] + " said, do you think it is possible that<br><b>" +
