...
var sents = {
    scales: {
	   ...
	   training2: {
        ...
        someHate_andAlsAll: {
            ...
            sent_question: "everyone hated your BB?"
        },
        
        someLove_andAlsAll: {
            sent_QUD: "How did people like my BB?",
            sent_utterance: "'Some people loved your BB.'", 
            sent_question: "everyone loved your BB?"
        }
    },
    domains: {
	training1: {
	...
	poem: {
	    sent_context: "Imagine that you have joined a poetry club, which consists of five members in addition to you. <br>Each week, one member writes a poem, and the five other members discuss the poem in the absence of its author. <br>This week, it is your turn to write a poem and to let others discuss it. <br>After the discussion, one fellow member confides to you that ", 
	    SP: "this fellow member",
	    LS: speakers3[1],
	    AA: "cookies",
	    BB: "poem",
        AB: "cookies and tea"
	...
	recipe: {
	    sent_context: "Imagine that you have joined a cooking club, which consists of five members in addition to you. <br>Each week, one member brings in a recipe, and the five other members discuss the recipe in the absence of its author. <br>This week, it is your turn to bring in a recipe and to let others discuss it. <br>After the discussion, one fellow member confides to you that ",
	    SP: "this fellow member",
	    LS: speakers4[1],
	    AA: "puzzles",
	    BB: "recipe",
...
//	   sent_context = sents["domains"][domain]["sent_context"];
	   ...
	   sent_materials = doSentSubs(sents, scale, domain);	
	    ...
	    $("#sent_context").html("<center>" + sent_materials[2] + sent_materials[0] + "<center><br>");
